...
public class MapView extends AppCompatActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    private void getStudentDetail() {
        StringRequest stringRequest = new StringRequest(Config.STD_INFO, new Response.Listener<String>() {
            @Override
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            alert = Integer.parseInt(geoData.getString("failStatus"));

            //spd = geoData.getString(Config.KEY_SPEED);
            //new MainActivity.GetDirection().execute();
